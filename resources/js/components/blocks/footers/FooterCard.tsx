        ...
        <footer className="bg-gray-900 text-gray-300">
            ...
            <div className="mx-auto max-w-11/12 px-6 py-12 lg:px-8">
                <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    {/* Hours */}
                    <div>
                        <h4 className="mb-4 flex items-center gap-2 text-sm font-semibold tracking-wider text-white uppercase">
                    ...
                    <div>
                        ...
                        <div className="mt-3">
                            <a
                                ...
                                className="inline-flex items-center gap-2 text-sm font-medium text-white transition-colors hover:text-orange-500"
                            >
                        ...
                        <div className="flex gap-2">
                            {socialLinks.map(({ Icon, href, label }) => (
                                <a
                                    ...
                                    aria-label={label}
                                    className="rounded-full bg-gray-800 p-2 text-gray-400 transition-all hover:scale-110 hover:bg-orange-600 hover:text-white"
                                >
                ...
                <div className="mt-10 border-t border-gray-800 pt-6 text-center">
                    <p className="text-xs text-gray-500">
                        © {currentYear} {footer.companyName}. All rights
                        reserved.
                    </p>
                </div>
            </div>
