...
export default function Edit() {
    ...
    const { role, permissions } = usePage<EditPageProps>().props;
                ...
                <div className="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-muted-foreground mt-1">Update role details and permissions</p>
                        </div>
                        ...
                        <CardContent>
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mt-2 max-h-64 overflow-y-auto p-2 border rounded-md">
