...
export function TopMenu() {
    ...
    return (
        <header
            className={cn(
                "fixed top-0 left-0 right-0 z-50 flex h-16 bg items-center bg-background dark:bg-slate-900 text-foreground dark:text-slate-100 px-4 sm:px-6 border-b-2 border-border/50 dark:border-slate-800/50 shadow-sm"
            )}
        >
            {/* Left: Logo */}
