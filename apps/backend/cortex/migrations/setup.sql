...
SET @password_hash = '$2b$10$K.0HwpzrofzVonxL9jvWCujEpIea5g0aZQnOIEuYDT0nmdrSBNMOy'; -- bcrypt hash for 'user123'
SET @admin_password_hash = '$2b$10$K.0HwpzrofzVonxL9jvWCujEpIea5g0aZQnOIEuYDT0nmdrSBNMOy'; -- bcrypt hash for 'admin123'

INSERT INTO users (username, email, password_hash, mobile, status, tenant_id, role) VALUES
                                                                                        ('user1_tenant1', 'user1@tenant1.com', @password_hash, '1234567890', 'active', 'tenant1', 'user'),
                                                                                        ('user2_tenant1', 'user2@tenant1.com', @password_hash, NULL, 'active', 'tenant1', 'user'),
                                                                                        ('admin', 'admin@example.com', @admin_password_hash, '9876543210', 'active', 'tenant1', 'admin');

-- Sample revoked token
...
INSERT INTO users (username, email, password_hash, mobile, status, tenant_id, role) VALUES
                                                                                        ('user1_tenant2', 'user1@tenant2.com', @password_hash, '1234567890', 'active', 'tenant2', 'user'),
                                                                                        ('user2_tenant2', 'user2@tenant2.com', @password_hash, NULL, 'active', 'tenant2', 'user'),
                                                                                        ('admin', 'admin@example.com', @admin_password_hash, '9876543210', 'active', 'tenant2', 'admin');
